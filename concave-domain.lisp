        ...
        (let ((denom (- (* (x v2) (y v1))
          ...
          (if (< (abs denom) *epsilon*)
              ...
              (let* ((t1 (/ (- (* (y v2) (x d))
                ...
                (cond ((< 0 t1 1)
                       (cond ((< 0 t2 1) 0)
                             ((<= t2 0) (abs (scalar-product (normal v1) d)))
                             ((>= t2 1) (abs (scalar-product (normal v1) (v- d v2))))))
                      ((< 0 t2 1)
                       (cond ((<= t1 0) (abs (scalar-product (normal v2) d)))
                             ((>= t1 1) (abs (scalar-product (normal v2) (v+ d v1))))))
                      ((and (<= t1 0) (<= t2 0))
                       (vlength d))
                      ((and (>= t1 1) (<= t2 0))
                       (vlength (v+ d v1)))
