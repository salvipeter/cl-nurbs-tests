...
(defun segment-segment-distance (a b)
  "TODO"
  (min (point-distance (first a) (first b))
       (point-distance (first a) (second b))
       (point-distance (second a) (first b))
       (point-distance (second a) (second b))))
