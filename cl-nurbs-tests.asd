...
(asdf:defsystem :cl-nurbs-tests
  ...
  :components ((:file "package")
	       ...
	       (:file "n-patch" :depends-on ("g-krr" "kobbelt"))
               ...
               (:file "utils")
               (:file "deficiency" :depends-on ("barycentric-parameterization" "utils"))
               (:file "gb-alternative-parameters" :depends-on ("deficiency"))
               (:file "gb-central-layer-tests" :depends-on ("deficiency"))
               (:file "gb-find-optimal-delta" :depends-on ("gb-alternative-parameters"))
               (:file "gb-delta-fullness" :depends-on ("gb-alternative-parameters"))))
