...
(defun biquadratic-net (points segments)
  ...
  (let ((net (make-array '(3 3)))
    ...
    (if (= n 3)
	(setf (aref net 1 0) (affine-combine (first segments) 3/4 (second segments))
	      (aref net 1 2) (affine-combine (third segments) 1/4 (fourth segments))
	      (aref net 2 0) (affine-combine (first segments) 1/2 (second segments))
	...
	(let* ((i (position (fourth segments) points :test #'equal))
	  ...
	  (setf (aref net 1 0) (affine-combine (first segments) 1/2 (second segments))
...
(defun biquadratic-corner-net (points segments)
  ...
  (let ((net (make-array '(3 3)))
    ...
    (setf 
	  ...
	  (aref net 1 1) (central-point points (lines-from-points points) t))
    (if (= n 3)
	(setf (aref net 2 1) (second segments)
	      (aref net 2 0) (affine-combine (second segments) 1/2 (third segments))
	      (aref net 1 0) (affine-combine (second segments) 3/4 (third segments))
	      (aref net 2 2) (affine-combine (first segments) 1/2 (second segments))
	      (aref net 0 1) (affine-combine (third segments) 1/4 (fourth segments))
	      (aref net 0 2) (affine-combine (third segments) 1/2 (fourth segments))
	      (aref net 1 2) (fourth segments))
	(let* ((i (position (fourth segments) points :test #'equal))
	       (k (ceiling n 2))
