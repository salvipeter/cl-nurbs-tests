...
(defun write-hermite (p0 t0 p1 t1 filename)
  (let (curve curvature derivative blend blend-derivative blend2 blend2-derivative)
    ...
    (with-open-file (s filename :direction :output :if-exists :supersede)
      ...
      (point s (v+ p0 (v* t0 1/4)) :color *green* :window 0)
      (polyline s (list p0 (v+ p0 (v* t0 1/4))) :color *blue* :window 0)
      (point s p1 :color *red* :window 0)
      (point s (v+ p1 (v* t1 1/4)) :color *green* :window 0)
      (polyline s (list p1 (v+ p1 (v* t1 1/4))) :color *blue* :window 0)
      (polyline s (list (v+ p0 (v* t0 1/4)) (v+ p1 (v* t1 1/4))) :color '(127 0 127) :window 0)
...
(defun write-tomi (p0 t0 p1 t1 filename)
  (let (curve curvature derivative blend blend-derivative)
    ...
    (with-open-file (s filename :direction :output :if-exists :supersede)
      ...
      (title s "Curve" :window 0)
      (point s p0 :color *red* :window 0)
      (point s (v+ p0 (v* t0 1/2 *ribbon-multiplier-start*)) :color *green* :window 0)
      (polyline s (list p0 (v+ p0 (v* t0 1/2 *ribbon-multiplier-start*))) :color *blue* :window 0)
      (point s p1 :color *red* :window 0)
      (point s (v+ p1 (v* t1 1/2 *ribbon-multiplier-end*)) :color *green* :window 0)
      (polyline s (list p1 (v+ p1 (v* t1 1/2 *ribbon-multiplier-end*))) :color *blue* :window 0)
      (polyline s (list (v+ p0 (v* t0 1/2 *ribbon-multiplier-start*))
			(v+ p1 (v* t1 1/2 *ribbon-multiplier-end*)))
		:color '(127 0 127) :window 0)
      (polyline s curve :window 0)
      (iter (for line in curvature)
	    (polyline s line :window 0))
      ;; Derivative
